#!/bin/bash
# NalTool Installer for macOS/Linux
# Made by Kacefier
...
print_header() {
    echo -e "${BLUE}NalTool Installer v${VERSION}${NC}"
...
echo "Please enter the path to the NalTool binary file"
echo ""
...
echo ""
echo "You can now use 'naltool' command:"
echo "  naltool --help"
echo "  naltool -i"
echo "  naltool -e file.txt -k \"key\""
echo ""
echo "If 'naltool' is not found, please restart your terminal"
